...
public class RadixSort {
    public static void main(String args[]) {
        int[] arr = {21, 132, 3, 310, 154, 146, 479, 577, 668, 769, 950, 295, 5, 54};
        System.out.println("------------------------");
        Sort(arr);
    ...
    public static void Sort(int[] arr) {
        ...
        for (int num = 0, n = 1, temp = 0; num < maxSize; num++, n *= 10, temp = 0) {
            ...
            for (int[] ara1 : ara) {
                System.out.println("ara：" + Arrays.toString(ara1) + "-----rar：" + Arrays.toString(rar));
            }
            ...
            System.out.println("每轮结束：Arr：" + Arrays.toString(arr));
        }
